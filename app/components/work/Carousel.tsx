...
export default function Carousel() {
    ...
    return (
        <div className="relative w-full h-64 md:h-96 lg:h-[500px] overflow-hidden">
            ...
            <button
                onClick={handlePrev}
                className="absolute top-1/2 left-4 transform -translate-y-1/2 text-white bg-black bg-opacity-50 py-4 px-6 rounded-full"
            >
                &#10094;
            </button>
            <button
                onClick={handleNext}
                className="absolute top-1/2 right-4 transform -translate-y-1/2 text-white bg-black bg-opacity-50 py-4 px-6 rounded-full"
            >
                &#10095;
            </button>
        </div>
