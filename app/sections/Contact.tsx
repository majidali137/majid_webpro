                ...
                <div className="mt-10 flex flex-col items-center justify-center sm:mt-0 mx-auto " >
                    ...
                    >
                        <AnimatedTitle
                            ...
                            subClassName="mt-4 sm:mt-1 px-6 text-center text-[40px] sm:text-[35px] md:mb-16 md:text-[400px] lg:text-[50px] font-semibold leading-[1em] tracking-tighter text-[#FFD600]"
