...
const Eduction = () => {
    ...
    return (
        <section
            className="relative z-10 w-full items-center justify-center overflow-hidden bg-[#0E1016] bg-cover bg-center mb-8  "
            id="education"
        >
            ...
            <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
                <AnimatedTitle
                    text={"My Education"}
                    className={
                        "mb-10 text-center text-[40px] font-bold leading-[0.9em] tracking-tighter text-[#e4ded7] sm:text-[45px] md:text-[60px] lg:text-[80px]"
                    }
                    wordSpace={"mr-[14px]"}
                    charSpace={"mr-[0.1em]"}
                />

                <div className="mx-auto w-[100%] lg:max-w-[1200px] justify-center pt-10 ">
